      ...
      <div>
        ...
        <ol>
          ...
          <li>
            ...
            {nameOfBusiness} at any time. Upon terminating your viewing of these materials or upon the termination of
        ...
        <ol>
          <li>
            ...
            inability to use the materials on {nameOfBusiness} Internet site, even if {nameOfBusiness} or a{' '}
            {nameOfBusiness} authorized representative has been notified orally or in writing of the possibility of such
        ...
        <ol>
          <li>
            The materials appearing on {nameOfBusiness} web site could include technical, typographical, or photographic
            errors. {nameOfBusiness} does not warrant that any of the materials on its web site are accurate, complete,
            or current. {nameOfBusiness} may make changes to the materials contained on its web site at any time without
            notice. {nameOfBusiness} does not, however, make any commitment to update the materials.
          </li>
        </ol>
